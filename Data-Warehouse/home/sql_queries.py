...
songplay_table_insert = ("""
    ...
    SELECT  TIMESTAMP 'epoch' + se.ts/1000 * interval '1 second' AS start_time,
            CAST(NULLIF(se.userId, '') AS INT), se.level, ss.song_id, ss.artist_id, se.sessionId, se.location, se.userAgent
...
user_table_insert = ("""
    ...
    SELECT DISTINCT CAST(NULLIF(userId, '') AS INT), firstName, lastName, gender, level
    FROM staging_events
